...
SITE_URL = "https://kundan.ai/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://kundan.ai/"
BLOG_AUTHOR='Kundan'
BLOG_EMAIL = "demo@kundan.ai"
BLOG_DESCRIPTION = "Welcome to my blog! Here I share my views on Machine Learning, Deep Learning and AI."  # (translatable)
...
DATE_FORMAT = 'd MMM, y' #'yyyy-MM-dd'
...
LOGO_URL = '/images/mariani-ai-logo-name.png'
...
FAVICONS = (
     ("icon", "/images/mariani-ai-favicon.png", "16x16"),
